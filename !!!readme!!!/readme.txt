...
レアスキルを書き込む時はrareskill.xlsxのファイルを開き、名前、レアスキル名、秒数を書き
その後、write_rareskill.exeをダブルクリックしコマンドプロンプトが終了したことを確認する。

※注意※
・saveファイルを削除するとソフト自体が起動しなくなってしまいます。

・ノインヴェルト、レアスキルが書かれているxlsxファイルを削除すると新たに書き込めなくなります。

・デスクトップに置いておきたい、もしくは別の所に実行ファイルを移動したいときはファイルを右クリックしてショートカットを作成してください。
